...
<div class="col-12">
              ...
              <div class="row no-print">
                <div class="col-12">
                  <a href="<?=base_url('admin/print/'.$transaksi->id_transaksi)?>" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Print</a>
                  
                  <a href="<?=base_url('admin/pesanan_masuk')?>" class="btn btn-primary float-right" style="margin-right: 5px;">
