            ...
            <div class="card card-primary card-outline card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-four-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="custom-tabs-four-profile-tab" data-toggle="pill" href="#custom-tabs-four-profile" role="tab" aria-controls="custom-tabs-four-profile" aria-selected="false">Dikemasi</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="tab-content" id="custom-tabs-four-tabContent">
                     ...
                     <table class="table text-center">
                         ...
                         <tr>
                            ...
                            <td>
                             ...
                             <td>
                             <a href="<?= base_url('pesanan_saya/rincian_pesanan/'.$value->id_transaksi) ?>" class="btn btn-xm btn-flat btn-warning"> Rincian Pesanan</a> <br>
                             <?php if($value->status_bayar == "0"){ ?>
                  ...
                  <table class="table text-center">
                         ...
                         <tr>
                            ...
                            <td>
                            <a href="<?= base_url('pesanan_saya/rincian_pesanan/'.$value->id_transaksi) ?>" class="btn btn-xm btn-flat btn-warning"> Rincian Pesanan</a>
                            </td>
                  ...
                  <table class="table text-center">
                         ...
                         <tr>
                            ...
                            <td>
                            <a href="<?= base_url('pesanan_saya/rincian_pesanan/'.$value->id_transaksi) ?>" class="btn btn-xm btn-flat btn-warning"> Rincian Pesanan</a> <br>
                              <button data-toggle="modal" data-target="#diterima<?= $value->id_transaksi ?>" class="btn btn-primary btn-xm btn-flat"> Diterima</button>
                            </td>
