...
<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
      ...
      <!-- LOGO
        ...
        <span class="brand-text font-weight-light"><b>BukaLapas</b></span>
      </a>
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          ...
          <?php $kategori= $this->m_home->listkategori(); ?>
          ...
          <li class="nav-item dropdown">
            ...
            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
              ...
              <li><a href="<?=base_url('home/bantuan')?>" class="dropdown-item">Bantuan</a></li>
        ...
        <?php echo form_open('home/cari') ?>
          <div class="input-group input-group-sm">
            <input name="keyword" class="form-control form-control-navbar" type="search" placeholder="Search" aria-label="Search">
      ...
      <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
        ...
        <img src="<?= base_url()?>assets/no_foto.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        </a>
       <?php } else {?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"> <?= $title ?></small></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?=base_url()?>"> BukaLapas </a></li>
