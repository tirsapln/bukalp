 ...
 <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <img src="<?= base_url()?>assets/logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">BukaLapas</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?= base_url() ?>assets/pengayoman.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            <a href="#"  class="nav-link <?php if($this->uri->segment(1)== 'barang' or $this->uri->segment(1)== 'gambarbarang'){ echo "active"; } ?>">
          ...
          <li class="nav-item has-treeview ">
            <a href="#"  class="nav-link <?php if($this->uri->segment(1)== 'user' or $this->uri->segment(1)== 'pelanggan'){ echo "active"; } ?>">
          ...
          <li class="nav-item has-treeview ">
            <a href="#"  class="nav-link <?php if($this->uri->segment(2)== 'qna' or $this->uri->segment(2)== 'pengaduan'){ echo "active"; } ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="<?= base_url('admin/pengaduan')?>" class="nav-link <?php if($this->uri->segment(2)== 'pengaduan'){ echo "active"; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pengaduan</p>
                </a>
              </li>
              <li class="nav-item">
              <a href="<?= base_url('admin/qna')?>" class="nav-link <?php if($this->uri->segment(2)== 'qna'){ echo "active"; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>QnA?</p>
                </a>
              </li>
